...
export const UsageLogsTable: React.FC = () => {
  return (
    <div className="overflow-hidden rounded-3xl border border-sky-100 bg-white/90 shadow-md shadow-sky-500/5 backdrop-blur-xl">
      <table className="w-full text-left text-sm">
        ...
        <tbody className="divide-y divide-sky-50 font-medium">
          {MOCK_LOGS.map((log) => {
            ...
            return (
              <tr key={log.id} className="hover:bg-sky-50/40 transition-colors duration-150">
