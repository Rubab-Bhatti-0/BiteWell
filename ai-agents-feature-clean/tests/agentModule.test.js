...
const agents_1 = require("../src/constants/agents");
...
async function runTests() {
    ...
    try {
        ...
        console.assert(agentsRes.body.length === agents_1.AI_AGENTS.length, `Expected ${agents_1.AI_AGENTS.length} agents`);
        ...
        console.assert(enable3.body.message === 'Maximum AI agents reached. Upgrade your subscription.', `Unexpected message: ${enable3.body.message}`);
