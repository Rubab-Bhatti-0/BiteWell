...
import { 
  ...
  Menu, Calendar, CreditCard, Send, Settings, ShieldAlert, CheckCircle2, Info,
  AlertTriangle
} from 'lucide-react';
...
export default function App() {
  const [activeTab, setActiveTab] = useState('dashboard'); // dashboard, patients, treatments, reports
    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ${isSidebarOpen ? 'pl-64' : 'pl-20'}`}>
        ...
        <header className="h-16 bg-white dark:bg-slate-800 border-b border-slate-200/85 dark:border-slate-700/85 flex items-center justify-between px-8 sticky top-0 z-30">
          ...
          {/* Active Clinic Detail / Stats Banner */}
      ...
      {/* TOAST SYSTEM (Alert notification sliders) */}
