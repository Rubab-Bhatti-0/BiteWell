...
import { 
  ...
  Menu, Calendar, CreditCard, Send, Settings, UserCheck, ShieldAlert, CheckCircle2, Info, BarChart3, LogOut, AlertTriangle, Package
} from 'lucide-react';
...
export default function App() {
  ...
  const menuItems = [
    ...
    { id: 'billing', label: 'Subscriptions', icon: Package, disabled: false, note: '' },
